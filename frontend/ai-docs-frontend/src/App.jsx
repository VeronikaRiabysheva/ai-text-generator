...
export default function App() {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFiles.length !== e.target.files.length) alert("Отфильтрованы файлы не-Python");
  ...
  return (
    <div className="container">
      <h1>Автогенерация документации</h1>
      ...
      <div className="upload-section">
        ...
        <button onClick={handleSubmit} disabled={loading || files.length === 0}>
          {loading ? "Генерация..." : "Сгенерировать Markdown"}
        </button>
      </div>
